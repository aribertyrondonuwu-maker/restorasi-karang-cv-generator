...
with tab1:
    ...
    with st.form("cv_form", clear_on_submit=False):
        ...
        cv_pendidikan = st.text_area("Format: Jenjang | Institusi | Bidang | Tahun", height=100, value="S1 | Universitas Sam Ratulangi | MSP | 1986-1991\nS2 | Università Delle Marche, Italia | Biodiversity & Management of Coral Reef | 2003-2004\nS2 | Universitas Sam Ratulangi | Ilmu Perairan | 2015-2017\nS3 | Universitas Sam Ratulangi | Ilmu Kelautan | 2017-2020", key="cv_pendidikan_input")
        
        st.subheader("🌊 Kepakaran: Restorasi Terumbu Karang")
        cv_restorasi = st.text_area("Format: Lokasi | Metode | Periode | Mitra", height=120, value="Pantai Malalayang, Manado | Transplantasi & CSC | 2009-kini | PT. TJ Silfanus\nTN Bunaken | Terumbu buatan + transplantasi | 2018-2020 | Balai TN Bunaken\nPulau Lembeh, Bitung | Terumbu buatan | 2020-2022 | DKP Bitung\nPoopoh, Minahasa | Transplantasi partisipatif | 2015-2020 | Masyarakat lokal", key="cv_restorasi_input")
        
        st.subheader("🔬 Pengalaman Penelitian (5 Tahun Terakhir)")
        cv_penelitian = st.text_area("Format: Tahun | Judul Penelitian | Sumber Dana", height=120, value="2022 | Pemetaan Habitat Perairan Dangkal dengan UAV di Likupang | LPPM Unsrat\n2021 | Pemetaan Ekosistem Terumbu Karang Pulau Serena dengan UAV | LPPM Unsrat\n2019-2020 | Optimalisasi Artificial Reef dan Restorasi Terumbu Karang di Poopoh | DRPM DIKTI\n2019-2020 | Monitoring Kesehatan Terumbu Karang di Raja Ampat | COREMAP-CTI LIPI", key="cv_penelitian_input")
        
        st.subheader("📚 Publikasi Ilmiah Terpilih")
        cv_publikasi = st.text_area("Format: Tahun | Judul | Jurnal | Indeks", height=100, value="2021 | Shallow water habitat mapping with UAV in Serena Island | AACL Bioflux 14(6) | Scopus Q3\n2020 | Mitochondrial CO1 sequences of Banggai Cardinalfish | AACL Bioflux 13(2) | Scopus Q3\n2023 | Biometrik Otolit Ikan Kardinal Banggai | Jurnal Ilmiah PLATAX 11(1) | SINTA", key="cv_publikasi_input")
        
        st.subheader("🤝 Pengabdian & Kebijakan Publik")
        col7, col8 = st.columns(2)
        with col7:
            cv_pengabdian = st.text_area("Format: Tahun | Kegiatan | Lokasi", height=100, value="2020 | Narasumber PEN Restorasi Terumbu Karang (ICRG) | Bali\n2021 | Transplantasi Karang Pantai Malalayang | Manado\n2016 | Modul Pelatihan Pemantauan Terumbu Karang (CCDP-IFAD) | Sulawesi Utara", key="cv_pengabdian_input")
        with col8:
            cv_kebijakan = st.text_area("Format: Tahun | Kegiatan | Lingkup", height=100, value="2021 | Tim Integrasi Perda RZWP3K ke Revisi Perda RTRW Sulut | Provinsi Sulut\n2020 | Tim Penyusun RPJMD Provinsi Sulawesi Utara 2021-2026 | Provinsi Sulut", key="cv_kebijakan_input")
        
        st.subheader("🤿 Sertifikasi & Pengalaman Selam (Opsional)")
        cv_sertifikasi = st.text_area("Format: Sertifikat / Pengalaman", height=80, value="Sertifikasi: CMAS 3-Star / PADI Divemaster\nPengalaman selam ilmiah: >500 jam selam\nSpesialisasi: Survei terumbu karang, transplantasi, monitoring", key="cv_sertifikasi_input")
        
        st.subheader("🛠️ Keahlian Inti")
        cv_keahlian = st.text_input("Pisahkan dengan koma", value="Koralogi, Ekologi Pesisir, Restorasi Terumbu Karang, UAV/Drone Mapping, GIS, DNA Barcoding, Scientific Diving", key="cv_keahlian_input")
...
# TAB 2: SURAT TUGAS
with tab2:
    st.info("️ Surat ini otomatis menyertakan klausul pembebasan tugas mengajar dan larangan rangkap bayar sesuai Diktum KETUJUH SK Dekan.")
    ...
    with st.form("st_form", clear_on_submit=False):
        ...
        klaim_8_oj = st.checkbox("Aktifkan Klausul 8 OJ/hari (Khusus Pembantu Peneliti)", value=(st_peran == "Pembantu Peneliti"), key="st_klaim_8oj_input")
